    ...
    return (
      <Segment>
        ...
        <Grid>
          <Grid.Row />
          <Grid.Column width={4}>
            <Header color="green" sub content="Step 1 - Add Photo" />
          ...
          <Grid.Column width={1} />
          <Grid.Column width={4}>
            <Header sub color="green" content="Step 2 - Resize image" />
            {this.state.files[0] && (
              <Cropper
          ...
          <Grid.Column width={1} />
          <Grid.Column width={4}>
            <Header sub color="green" content="Step 3 - Preview and Upload" />
            {this.state.files[0] && (
              <div>
                <Image
        ...
        <Divider />
        <Header sub color="green" content="All Photos" />
